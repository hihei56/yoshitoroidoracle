...
const LOLI_SHOTA_REGEX = new RegExp([
    ...
    'minor\\s*attract',
    'map(?:community|pride|flag)',   // "MAP" (Minor-Attracted Person)
    'hebephil','ephebophil',
...
const HATE_REGEX = new RegExp([
    ...
    'n\\s*[-_]\\s*word',
    'ニガー','ニガ(?!ー)',
    '黒人(?:は|が|を|め|野郎)?(?:死ね|消えろ|ゴミ|クズ|猿|バカ|出て行け|帰れ)',
    '(?:死ね|消えろ|ゴミ|クズ|猿)(?:黒人)',
    // ユダヤ差別・反ユダヤ
    'kike',
    'ユダヤ(?:の陰謀|が世界を支配|人め|人野郎|人を殺)',
    'ホロコースト(?:は嘘|なかった|否定)',
    'holocaust\\s*(?:denial|lie|fake|hoax|didn)',
    // 白人至上主義
    'white\\s*(?:power|supremac|nationalist)',
    'heil\\s*hitler',
    'ハイル\\s*ヒトラー',
    'ナチス(?:万歳|最高|を支持|賛美|正しい)',
    '14\\s*words',
    '(?:88|卍)\\s*(?:heil|hell|万歳)',
    // アジア系差別
    'chink','チンク',
    'gook',
    '(?:朝鮮|韓国)人(?:は)?(?:ゴキブリ|害虫|寄生虫|猿|死ね|消えろ)',
    'jap\\s*(?:die|kill|out)',
    // その他民族差別
    'towelhead','raghead',
    'sand\\s*n(?:igger|igga)',
